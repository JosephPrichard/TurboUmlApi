...
import com.turbouml.dao.PackageDao;
...
public class PackageService
{
    ...
    public void savePackage(String userId, UMLPackage newPackage)
    ...
    public List<UMLPackage> retrieveAllPackages(String userId, String projectId)
        throws AccessDeniedException
    {
