...
import com.turbouml.dao.FieldDao;
...
public class FieldService
{
    ...
    public void saveField(String userId, UMLField newField)
    ...
    public List<UMLField> retrieveAllFields(String userId, String classId)
        throws AccessDeniedException
    {
    ...
    public void updateField(String userId, UMLField updatedField)
        throws AccessDeniedException
    {
    ...
    public void batchUpdateFields(String userId, UMLField updatedField, List<String> fieldIdsToUpdate)
        throws AccessDeniedException
    {
