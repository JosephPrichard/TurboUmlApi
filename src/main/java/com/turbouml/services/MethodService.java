...
import com.turbouml.dao.MethodDao;
...
public class MethodService
{
    ...
    public void saveMethod(String userId, UMLMethod newMethod)
    ...
    public List<UMLMethod> retrieveAllMethods(String userId, String classId)
    ...
    public void updateMethod(String userId, UMLMethod updatedMethod)
        throws AccessDeniedException
    {
    ...
    public void batchUpdateMethods(String userId, UMLMethod updatedMethod, List<String> methodIdsToUpdate)
        throws AccessDeniedException
    {
        if(updatedMethod.isAbstract() && updatedMethod.isStatic()) {
            throw new InvalidArgumentsException("Method can't be both abstract and static");
