...
public class MethodDao
{
    ...
    public void save(UMLMethod newMethod)
    {
    ...
    public List<UMLMethod> findByClassId(String classId)
    {
        return create.select()
            .from(METHODS)
            .where(METHODS.CLASS_ID.eq(classId))
            .orderBy(METHODS.CONTENT_ORDER)
            .fetchInto(UMLMethod.class);
    }

    public void update(UMLMethod updatedMethod)
    {
        batchUpdate(
            updatedMethod,
    ...
    public void batchUpdate(UMLMethod updatedMethod, List<String> methodIdsToUpdate)
    {
