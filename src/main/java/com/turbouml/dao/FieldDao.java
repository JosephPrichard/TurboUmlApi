...
public class FieldDao
{
    ...
    public void save(UMLField newField)
    {
    ...
    public List<UMLField> findByClassId(String classId)
    {
        return create.select()
            .from(FIELDS)
            .where(FIELDS.CLASS_ID.eq(classId))
            .orderBy(FIELDS.CONTENT_ORDER)
            .fetchInto(UMLField.class);
    }

    public void update(UMLField updatedField)
    {
       batchUpdate(
           updatedField,
    ...
    public void batchUpdate(UMLField updatedField, List<String> fieldIdsToUpdate)
    {
