...
public class ClassDao
{
    ...
    public void save(UMLClass newClass)
    {
        create
            .insertInto(CLASSES,
                CLASSES.CLASS_ID,
    ...
    public UMLClass findByClassId(String classId)
    {
        return create.select()
            .from(CLASSES)
            .where(CLASSES.CLASS_ID.eq(classId))
            .fetchInto(UMLClass.class)
            .get(0);
    }

    public List<UMLClass> findByProjectId(String projectId)
    {
        return create.select()
            .from(CLASSES)
